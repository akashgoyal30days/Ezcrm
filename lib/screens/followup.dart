            ...
            child: Column(
              children: [
                        ...
                        child: Column(
                          children: [
                            Container(
                                ...
                                child: Text('Search for next 5 days', style: TextStyle(fontSize: 14,color: Colors.white, fontWeight: FontWeight.w300),)),
                           SizedBox(height: 10,),
                            Container(
                                height: 30,
                ...
                Container(
                  ...
                  child: list_follow.isNotEmpty ? ListView.builder(
