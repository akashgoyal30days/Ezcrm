...
//fetch state
  ...
  Future go_for_lead(String usrid, String client, String status, String lStart,
      String lEnd) async {
    lead_data = await Get_Leads(usrid, client, status, lStart, lEnd);
                          ...
                          child: ButtonTheme(
                            child: DropdownButton(
                              ...
                              onChanged: (newValue) {
                                setState(() {
                                  _valuenew = newValue;
                                  go_for_lead(userid, clientname, _valuenew,
                                      '0', '100');
                                  if (debug == 'yes') {
                                    print(_valuenew);
                                  }
