                                 ...
                                 children: [
                                   Container(
                                       ...
                                       child: Center(
                                         child: Padding(
                                           padding: const EdgeInsets.all(8.0),
                                           child: Text('Assigned Leads',style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white),),
                                         ),
                                       )),
                                 ],
                               ),
                  ...
                  if( _mycreditsource != null || _mycreditproduct != null  ){
                    ...
                    if(debug == 'yes') {print(res);}
                      ...
                      Future.delayed(const Duration(seconds: 2), ()
                            {
                              Navigator.pop(context);
      Toast.show(res['message'], context, duration: Toast.LENGTH_LONG,
