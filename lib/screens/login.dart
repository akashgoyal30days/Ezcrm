  ...
  Future glogin(String email, String token) async {
   ...
   // print('ttt-$token2');
    final response = await http.post(
        uri, body: {'email': email, 'type': 'glogin', 'fb_token': 'abc', 'token': token2
    },
 ...
 /* Future lll(String email) async {
                    ...
                    Padding(
                        ...
                        child: Column(
                          children: [
                            Text("Hold On!",style: TextStyle(fontSize: MediaQuery.of(context).size.width/10,color: Colors.black, letterSpacing: 1),),
                            SizedBox(height: 5,),
                            Text("We are matching details",style: TextStyle(fontSize: MediaQuery.of(context).size.width/18,color: Colors.black, letterSpacing: 1),),
                          ],
                        )),
                    Spacer(),
                  ],
  ...
  Future forgotpass(){
    if (fpassemailapistatus== 'not got it'){
      ...
      Toast.show(mymsg, context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM, backgroundColor: Colors.white.withOpacity(0.5), textColor: Colors.black, backgroundRadius: 1);
    }
    showModalBottomSheet(
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.vertical(top: Radius.circular(0.0)),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Image.asset('assets/images/fpass.jpg',
                      height: 200,
                      width: 200,),
                      Align(
                      ...
                      Align(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                           if(fpassemailnewController.text!= ''&& fpassemailnewController.text.contains('@')){
                             ...
                             showfpassloader();
                              ...
                              Toast.show("Please fill the correct email address to continue", context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM, backgroundColor: Colors.white.withOpacity(0.5), textColor: Colors.black, backgroundRadius: 1);
                            }
                          },
                          child: Container(
  ...
  Future forgotpassotp(){
    Toast.show('Enter the otp sent on your registered mobile number', context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM, backgroundColor: Colors.white.withOpacity(0.5), textColor: Colors.black, backgroundRadius: 1);
    Navigator.pop(context);
    showModalBottomSheet(
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.vertical(top: Radius.circular(0.0)),
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          if(otp == ''){
                            Toast.show('Please Fill OTP', context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM, backgroundColor: Colors.white.withOpacity(0.5), textColor: Colors.black, backgroundRadius: 1);
                          }else{
                            showfpassloader();
                           var otprespo = await fpassotp(otp,fpassresponse['data']['id'], fpassresponse['data']['client_id'],fpassresponse['data']['client_name'] );
                          print(otprespo);
                          ...
                          if (otprespo['status'] == true) {
                            ...
                            Future.delayed(const Duration(seconds: 2), () {
                              Navigator.pop(context);
                              Toast.show(otprespo['msg'], context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM, backgroundColor: Colors.white.withOpacity(0.5), textColor: Colors.black, backgroundRadius: 1);
                            });
                          }
    ...
    if (_currentUser != null) {
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: <Widget>[
              Center(child: Text("Login with",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),)),
              Center(child: Text("${_currentUser.email} ?", style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold),)),
              Divider(thickness: 5,color: Colors.white,),
              Center(child: Text(message, style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),)),
              Divider(thickness: 5,color: Colors.white,),
              if(message == 'login failed')Center(child: Text("Please Try With Correct Email Id")),
              Visibility(
                  visible: visible,
                  child: Container(
              ...
              try{
                ...
                if (rsp.containsKey('status')){
                  ...
                  if (rsp['status'] == true){
                    ...
                    preferenceusertype.setString('user_type', rsp['data']['upriv']);
                    SharedPreferences preferenceclient = await SharedPreferences.getInstance();
                    preferenceclient.setString('client_name', rsp['data']['client']);
                    SharedPreferences preferencecompany = await SharedPreferences.getInstance();
                    preferencecompany.setString('company', rsp['data']['company_name']);
                ...
                Toast.show('Unable To Reach Server, Please Check Your Internet', context, duration: Toast.LENGTH_LONG, gravity:  Toast.CENTER);
                setState(() {
                  btnstate = 'show';
                  message = '';
                });
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          color: Colors.white,
          child: Align(
              alignment: Alignment.center,child: Text('A Product of 30Days Technologies Pvt Ltd.',
