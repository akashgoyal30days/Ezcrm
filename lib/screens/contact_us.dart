                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async {
                          if (await canLaunch(
                              "https://www.youtube.com/channel/UCc44SkW1Su1FbzWOIDSQ_mw")) {
                            await launch(
                                "https://www.youtube.com/channel/UCc44SkW1Su1FbzWOIDSQ_mw");
                          }
                        },
                      ...
                      GestureDetector(
                        onTap: () async {
                          if (await canLaunch(
                              "https://www.facebook.com/EZCRM-109513837510284")) {
                            await launch(
                                "https://www.facebook.com/EZCRM-109513837510284");
                          }
                        },
                 ...
                 GestureDetector(
                   child: Align(
                      ...
                      GestureDetector(
                        onTap: () async {
                          if (await canLaunch(
                              "https://www.linkedin.com/company/53215816/admin/")) {
                            await launch(
                                "https://www.linkedin.com/company/53215816/admin/");
                          }
                        },
