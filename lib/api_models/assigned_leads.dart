...
Future Get_Leads_Type(String useruid, String clientt) async {
  ...
  final response = await http.post(
      uri, body: {'uid': useruid, 'client': clientt, 'type': 'fetch_status'},
...
Future Get_Leads(String useruid, String clientt, String stat_us, String start, String end) async {
  var uri = "${customurl}/leads.php";
  final response = await http.post(
      uri, body: {'uid': useruid,
    'client': clientt,
...
Future Get_Leads_followup(String useruid, String clientt,String lid,) async {
  var uri = "${customurl}/leads.php";
  final response = await http.post(
      uri, body: {'uid': useruid,
    'client': clientt,
